...
Using the [`alias`](/docs/v2/deployments/configuration/#alias) property inside of a [`now.json` file](/docs/v2/deployments/configuration), you can [automatically alias a deployment to your domain](/docs/v2/custom-domains#aliasing-a-project) by using the following Now CLI command in your terminal:
