...
With Now, you can deploy your application to [different environments](/docs/v2/custom-domains#aliasing-a-project), depending on what stage your application is at; either staging or production.
...
<Note hint>
  ...
  <GenericLink href="/docs/v2/custom-domains#aliasing-a-project">
    Aliasing Documentation.
  </GenericLink>
</Note>

For [production deployments](/docs/v2/custom-domains#aliasing-a-project), you can deploy to an alias of your choice. To do so, add an `alias` to your `now.json` file:
...
<Card title="Aliasing" href="/docs/v2/custom-domains#aliasing-a-project">
