...
export const meta = {
  ...
  editUrl: 'pages/docs/v2/domains-and-aliases/transferring-a-domain.mdx',
...
For more information on aliasing your deployments, you can read the [aliasing documentation](/docs/v2/domains-and-aliases/aliasing-a-deployment).
