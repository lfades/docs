...
export const meta = {
  ...
  lastEdited: '2019-07-19T22:19:53.000Z'
}
...
A variety of frameworks have been optimized for ZEIT Now deployments so that they are served with unparalleled defaults.
...
| ---------------- | ----------------------------------------------- | ------------------------------ |
| Preact           | `npx preact-cli default my-preact-project`      | <CheckmarkInCircle size="24"/> |
| Vue.js           | `npx @vue/cli create my-vue-project`            | <CheckmarkInCircle size="24"/> |
| Angular          | `npx @angular/cli new my-angular-project`       | <CheckmarkInCircle size="24"/> |
| Svelte           | `npx degit sveltejs/template my-svelte-project` | <CheckmarkInCircle size="24"/> |
| Polymer          | `npx polymer-cli init polymer-3-starter-kit`    | <CheckmarkInCircle size="24"/> |
| Create React App | `npx create-react-app my-cra-project`           | <CheckmarkInCircle size="24"/> |
| Gridsome         | `npx @gridsome/cli create my-gridsome-project`  | <CheckmarkInCircle size="24"/> |
| UmiJS            | `npm create umi my-umi-project`                 | <CheckmarkInCircle size="24"/> |
| Docusaurus       | `npx docusaurus-init`                           | <CheckmarkInCircle size="24"/> |
