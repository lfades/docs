...
export const meta = {
  ...
  lastEdited: '2019-07-17T20:08:58.000Z'
}
...
The projects structure enables faster locating of [deployments logs, source](/docs/v2/deployments/concepts/special-paths), and [aliases](/docs/v2/custom-domains#aliasing-a-project).
