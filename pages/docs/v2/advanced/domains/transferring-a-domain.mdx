...
export const meta = {
  ...
  editUrl: 'pages/docs/v2/domains/advanced/transferring-a-domain.mdx',
...
For more information on aliasing your deployments, you can read the [aliasing documentation](/docs/v2/custom-domains#aliasing-a-project).
...
<Card
  ...
  href="/docs/v2/advanced/domains/buying-a-domain"
>
