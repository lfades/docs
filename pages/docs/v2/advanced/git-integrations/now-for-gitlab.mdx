...
export const meta = {
  ...
  editUrl: 'pages/docs/v2/advanced/git-integrations/now-for-gitlab.mdx',
...
- Instant rollbacks when reverting changes that have already been [aliased](/docs/v2/custom-domains#aliasing-a-project).
