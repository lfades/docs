...
This allows you to examine the evolution of a project over time. In addition, if a bug is detected, you can instantly roll back by changing the [alias](/docs/v2/custom-domains#aliasing-a-project) of your production domain.
