...
Additionally, we also purge all caches related to a deployment when [an alias](/docs/v2/custom-domains#aliasing-a-project) is created or updated, as this implies that new content needs to be served, thus requiring purging the caches.
