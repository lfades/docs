...
A deployment is always associated with a unique URL and [a staging alias](/docs/v2/custom-domains#aliasing-a-project). The unique URL has the following fundamental components:
