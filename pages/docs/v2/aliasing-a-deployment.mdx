...
The same mechanism used above can be used to configure [a **custom domain**](/docs/v2/domains-and-aliases/adding-a-domain).
...
Otherwise, you need to [add the domain](/docs/v2/domains-and-aliases/adding-a-domain) to your <Now color="#000"/> account or team.
