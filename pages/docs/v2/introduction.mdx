...
export const meta = {
  ...
  lastEdited: '2019-07-17T18:07:42.000Z'
}
...
To deploy with Now, you will need to install Now CLI, a frequently updated, and [open-source](https://github.com/zeit/now-cli), command-line interface.

You can get Now CLI from either npm or Yarn. Using npm, run the following command from your terminal:

<TerminalInput>npm install --global now</TerminalInput>
