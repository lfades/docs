...
export const meta = {
  ...
  editUrl: 'pages/docs/v2/deploying-and-developing/local-development.mdx',
...
For this example we will use Gatsby, you are free to use whichever project you would like to, however.
