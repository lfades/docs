...
export const meta = {
  ...
  lastEdited: '2019-07-18T12:19:58.000Z'
}
...
Once linked, you will guided through setup by choosing repositories or projects to enable deployments with, and then Now will begin deploying each push on those selected repositories or projects autonimously.
...
<Card
  ...
  href="/docs/v2/deployments/serverless-functions"
>
