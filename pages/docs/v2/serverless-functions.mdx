...
Then, deploying with Now CLI with the `now` command from your terminal will result in a serverless Python function and with a link like the following: <https://python-api.now-examples.now.sh/api/date>
