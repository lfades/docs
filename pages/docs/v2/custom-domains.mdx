...
export const meta = {
  ...
  lastEdited: '2019-07-19T14:57:14.000Z'
}
...
That's it! You're ready to [alias your deployments](/docs/v2/custom-domains#aliasing-a-project) and [create DNS records](/docs/v2/advanced/domains/dns). Your wildcard certificate is created automatically.
...
For each domain you want to alias, add a `CNAME` record with a value `alias.zeit.co` to your external DNS. Then you can [alias your deployments](/docs/v2/custom-domains#aliasing-a-project) as usual!
...
To use the custom domain with your project, you must add an alias to the project from the **Domains** section of the project dashboard.
