...
**Default Version**: 8.10.x (or [defined](#defined-node.js-version))
...
Deploying a Node.js function with the `.ts` extension will automatically be recognised at a TypeScript file and compiled to a serverless function.
...
### Node.js Request and Response Obejcts
...
<Card title="Deployment Introduction" href="/docs/v2/introduction">
