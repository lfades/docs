export default [
  ...
  {
    name: 'Deploying and Developing',
    highlightCategory: true,
    posts: [
      {
        name: 'Cloud Deployment',
        href: '/docs/v2/deploying-and-developing/cloud-deployment'
      },
      {
        name: 'Local Development',
        href: '/docs/v2/deploying-and-developing/local-development'
      },
      {
        name: 'Environment Variables and Secrets',
        href:
          '/docs/v2/deploying-and-developing/environment-variables-and-secrets'
      },
      {
        name: 'Frequently Asked Questions',
        href: '/docs/v2/deploying-and-developing/frequently-asked-questions'
      }
    ]
  },
  {
