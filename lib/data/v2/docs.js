    ...
    posts: [
      ...
      },
      {
        ...
        posts: [
          ...
          {
            name: 'Node.js Server',
            href: '/docs/v2/advanced/builders/node-js-server-now-node-server'
          },
          {
            name: 'Next.js',
          ...
          {
            name: 'mdx-deck',
            href: '/docs/v2/advanced/builders/mdx-deck-now-mdx-deck'
          },
          {
            name: 'OptiPNG',
            href: '/docs/v2/advanced/builders/optipng-now-optipng'
          },
          {
            name: 'HTML Minifier',
            href: '/docs/v2/advanced/builders/html-minifier-now-html-minifier'
          },
          {
            name: 'Markdown',
            href: '/docs/v2/advanced/builders/markdown-now-md'
          }
        ]
      },
      {
