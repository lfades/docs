export default [
  {
    ...
    posts: [
      {
        name: 'Introduction',
        href: '/docs/v2/basics/introduction'
      },
      {
        name: 'Git Integration',
        href: '/docs/v2/basics/git-integration'
      },
      {
        name: 'Build Step',
        href: '/docs/v2/basics/build-step'
      },
      {
        name: 'Custom Domains',
        href: '/docs/v2/basics/custom-domains'
      }
    ]
  },
  {
    name: 'Deployment Basics',
    href: '/docs/v2/deployment-basics',
    highlightCategory: true
  },
  {
    name: 'Serverless Functions',
    href: '/docs/v2/serverless-functions',
    highlightCategory: true
  },
  {
    name: 'Aliasing a Project',
    href: '/docs/v2/aliasing-a-deployment',
    highlightCategory: true
  },
  {
    name: 'Environment Variables and Secrets',
    href: '/docs/v2/environment-variables-and-secrets',
    highlightCategory: true
  },
  {
    ...
    posts: [
      {
        ...
        href: '/docs/v2/domains/adding-a-domain'
      },
      {
        name: 'Buying a Domain',
        href: '/docs/v2/domains/buying-a-domain'
      },
      {
        name: 'Transferring a Domain',
        href: '/docs/v2/domains/transferring-a-domain'
      },
      {
        name: 'Managing DNS',
        href: '/docs/v2/domains/dns'
      }
    ]
  },
  {
    ...
    posts: [
      {
        ...
        posts: [
          {
            name: 'Now for GitHub',
            href: '/docs/v2/advanced/git-integrations/now-for-github'
          },
          {
            name: 'Now for GitLab',
            href: '/docs/v2/advanced/git-integrations/now-for-gitlab'
          }
        ]
      },
      {
